...
void init_calib_params(void)
{
	...
	if(lavie_params.calib_params.avgsq_noise_x > 200 && lavie_params.calib_params.avgsq_noise_x < 200000
			&& lavie_params.calib_params.avgsq_noise_y > 200 && lavie_params.calib_params.avgsq_noise_y < 200000
			&& lavie_params.calib_params.avgsq_noise_z > 200 && lavie_params.calib_params.avgsq_noise_z < 200000
			&& lavie_params.calib_params.avgsq_noise_xyz > 200 && lavie_params.calib_params.avgsq_noise_xyz < 300000)
	{
...
void save_calib_params(const calib_params_t calib_params)
{
	memcpy(&lavie_params.calib_params, &calib_params, sizeof(calib_params_t));
